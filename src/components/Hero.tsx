...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative text-white">
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#9001FE]/80 via-purple-600/70 to-[#6FFE01]/80"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            🚴‍♂️ Fini les Galères !
            <br />
            <span className="bg-gradient-to-r from-[#6FFE01] to-white bg-clip-text text-transparent">Votre Vélo Arrive Avant Vous ! 🏆</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button
              ...
              className="bg-white text-[#9001FE] px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-50 transform hover:scale-105 transition-all duration-200 shadow-lg flex items-center space-x-2"
            >
            ...
            <button
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-[#9001FE] transition-all duration-200"
            >
              📞 Nous contacter
            </button>
          </div>
      ...
      <div className="absolute bottom-0 w-full">
        <svg viewBox="0 0 1440 120" className="w-full h-16 fill-gray-900">
